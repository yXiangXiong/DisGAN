...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_horizontal', type=float, default=0.001, help='initial learning rate')
    ...
    parser.add_argument('--dataset_name', default='butterfly2', type=str, help='Choose the dataset name for save path')
    parser.add_argument('--project_name', default='cyclegan_alexent', type=str, help='Choose the project name for save path')
